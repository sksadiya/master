            ...
            <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user ">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ route('settings') }}"><i class="fas fa-user me-2"></i> <span class="align-middle">Profile</span></a>
                        <a class="dropdown-item " href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fas fa-power-off me-2"></i> <span key="t-logout">@lang('translation.logout')</span></a>
