...
<script>
  $(document).ready(function () {
    ...
    serverSide: true,
    ajax: {
        url: '{{ route('serviceCategories.data') }}',
        type: 'GET',
    ...
    $('#editCategoryForm').on('submit', function (e) {
      ...
      const catRoute = "{{ route('serviceCategory.update', 'ID') }}";
    ...
    $('#delete-record').on('click', function () {
      var categoryId = $(this).data('id');
      const delRoute = "{{ route('serviceCategory.delete', 'ID') }}";
