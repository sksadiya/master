        ...
        <div class="col-xxl-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <h5 class="fs-15 mb-4">Profile Page Structure</h5>
                    <div class="hstack gap-2 justify-content-center">
                        <button class="btn btn-danger btn-sm"><i class="ri-stop-circle-line align-bottom me-1"></i>
                            Stop</button>
                        <button class="btn btn-secondary btn-sm"><i class="ri-play-circle-line align-bottom me-1"></i>
                            Start</button>
                    </div>
                </div>
            </div>
                            ...
                            <div data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-15"><a href="pages-profile">Joseph Parker</a> <small
                                        ...
                                        <div class="d-flex mt-4">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="pages-profile">Tonya Noble</a>
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-15"><a href="pages-profile">Thomas Taylor</a> <small
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-15"><a href="pages-profile">Tonya Noble</a> <small
                                        ...
                                        <div class="d-flex mt-4">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="pages-profile">Nancy Martino</a>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3 flex-grow-1">
                                                        <h6 class="fs-15 mb-0"><a href="javascript:void(0)"
                                                                class="link-secondary">App pages.zip</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>Zip File</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3 flex-grow-1">
                                                        <h6 class="fs-15 mb-0"><a href="javascript:void(0);"
                                                                class="link-secondary">Velzon admin.ppt</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>PPT File</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3 flex-grow-1">
                                                        <h6 class="fs-15 mb-0"><a href="javascript:void(0);"
                                                                class="link-secondary">Images.zip</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>ZIP File</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3 flex-grow-1">
                                                        <h6 class="fs-15 mb-0"><a href="javascript:void(0);"
                                                                class="link-secondary">Bg-pattern.png</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>PNG File</td>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="pages-profile"
                                                            class="fw-medium link-secondary">Thomas Taylor</a>
                                                    </div>
                                                </div>
                                            </th>
                                            <td>02 Jan, 2022</td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ URL::asset('build/images/users/avatar-10.jpg') }}" alt=""
                                                        class="rounded-circle avatar-xxs">
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="pages-profile" class="fw-medium link-secondary">Tonya
                                                            Noble</a>
                                                    </div>
                                                </div>
                                            </td>
