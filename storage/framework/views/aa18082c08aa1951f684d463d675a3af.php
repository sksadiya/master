      ...
      <div class="card-body">
        <div class="listjs-table" id="employeesList">
          <div class="row g-4 mb-3">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Add Employees')): ?>
            <div class="col-sm-auto">
              <div>
                <a href="<?php echo e(route('employee.add')); ?>" type="button" class="btn btn-primary add-btn"><i class="fas fa-plus-circle me-2"></i> Add employee</a>
              </div>
            </div>
            <?php endif; ?>
          </div>
            ...
            <table class="table align-middle table-nowrap" id="employeeTable">
              <thead class="table-light">
                <tr>
                  ...
                  <th>Email</th>
                  <th>Contact</th>
                  <?php if(Auth::user()->can('Edit Employees') || Auth::user()->can('Delete Employees')): ?>
                  <th>Action</th>
                  <?php endif; ?>
                </tr>
              </thead>
