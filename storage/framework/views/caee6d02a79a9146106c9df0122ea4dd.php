  ...
  <div class="col-xxl-12">
    ...
    <div class="card-header">
      ...
      <div class="card-body p-4">
        <form action="<?php echo e(route('client.update',$client->id)); ?>" method="post" id="client-create-form" name="client-create-form"
...
unset($__errorArgs, $__bag); ?>" id="first_name"
                  placeholder="First name" value="<?php echo e($client->first_name); ?>" name="first_name">
...
unset($__errorArgs, $__bag); ?>" id="last_name"
                  placeholder="Last name"value="<?php echo e($client->last_name); ?>" name="last_name">
...
unset($__errorArgs, $__bag); ?>" id="business"
                  placeholder="Business Name" value="<?php echo e($client->business); ?>" name="business">
...
unset($__errorArgs, $__bag); ?>" id="contact"
                  placeholder="contact" value="<?php echo e($client->contact); ?>" name="contact">
...
unset($__errorArgs, $__bag); ?>" id="alter_contact"
                  placeholder="Phone no." value="<?php echo e($client->alter_contact); ?>" name="alter_contact">
...
unset($__errorArgs, $__bag); ?>" id="email"
                  placeholder="email Name" value="<?php echo e($client->email); ?>"  name="email">
...
unset($__errorArgs, $__bag); ?>" id="website"
                  placeholder="Website" value="<?php echo e($client->website); ?>" name="website">
...
unset($__errorArgs, $__bag); ?>" id="postal_code"
                  placeholder="Zip Code" value="<?php echo e($client->postal_code); ?>" name="postal_code">
...
unset($__errorArgs, $__bag); ?>" id="GST"
                  placeholder="GSTIN" value="<?php echo e($client->GST); ?>" name="GST">
...
unset($__errorArgs, $__bag); ?>" cols="5" rows="5" id="notes"
                      placeholder="Add Notes Here" value="<?php echo e($client->Notes); ?>" name="notes"></textarea>
...
<script src="<?php echo e(asset('build/js/pages/profile-setting.init.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\master\resources\views/client/edit.blade.php ENDPATH**/ ?>