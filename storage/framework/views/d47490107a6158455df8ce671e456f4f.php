...
<script>
  ...
  <?php endif; ?>
    ...
    serverSide: true,
    ajax: {
        url: '<?php echo e(route('tasks.data')); ?>',
        type: 'GET',
...
$('#tasksTable').on('click', '.remove-item-btn',function () {
    ...
    $('#delete-record').on('click', function () {
      var taskId = $(this).data('id');
      console.log(taskId);
      const delRoute = "<?php echo e(route('task.delete', 'ID')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\master\resources\views/task/index.blade.php ENDPATH**/ ?>