...
<script>
  $(document).ready(function () {
    ...
    serverSide: true,
    ajax: {
        url: '<?php echo e(route('expenseCategories.data')); ?>',
        type: 'GET',
    },
    columns: [
        { data: 'name', name: 'name' },
    ...
    $('#addExpenseCategory').on('submit', function (e) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo e(route("expenseCategory.add")); ?>',
        data: $(this).serialize(),
    ...
    $('#editExpenseCategoryForm').on('submit', function (e) {
      ...
      const catRoute = "<?php echo e(route('expenseCategory.update', 'ID')); ?>";
    ...
    $('#delete-record').on('click', function () {
      var categoryId = $(this).data('id');
      const delRoute = "<?php echo e(route('expenseCategory.delete', 'ID')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\master\resources\views/expenseCategory/index.blade.php ENDPATH**/ ?>