...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="<?php echo e(route('root')); ?>" class="logo logo-light">
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset('public/images/uploads/'.$settings['app-fevicon'])); ?>" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src="<?php echo e(URL::asset('public/images/uploads/'.$settings['app-logo'])); ?>" alt="" width="200px"  height="36">
            </span>
        </a>
