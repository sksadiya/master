      ...
      <div class="card-body">
        <div class="listjs-table" id="departmentList">
          <div class="row g-4 mb-3">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Add project')): ?>
            <div class="col-sm-auto">
              <div>
                <a href="<?php echo e(route('project.add')); ?>" class="btn btn-primary add-btn" 
                  ><i class="fas fa-plus-circle me-2"></i> Add project</a>
              </div>
            </div>
            <?php endif; ?>
          </div>
...
<script>
  ...
  <?php endif; ?>
    ...
    serverSide: true,
    ajax: {
        url: '<?php echo e(route('projects.data')); ?>',
        type: 'GET',
    ...
    $('#delete-record').on('click', function () {
      var deptId = $(this).data('id');
      const delRoute = "<?php echo e(route('project.delete', 'ID')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\master\resources\views/project/index.blade.php ENDPATH**/ ?>